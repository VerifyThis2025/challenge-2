# VerifyThis 2025 - Challenge 2

This is the first challenge for the VerifyThis 2025 competition. Please see the file [challenge-2.pdf](challenge-2.pdf) for the problem description and list of tasks.
...
* Then execute the following git command: <br/>
  ```bash
  git clone https://github.com/VerifyThis2025/challenge-2-<YOUR-TEAM-NAME>.git challenge-2
  cd challenge-2
  ```
